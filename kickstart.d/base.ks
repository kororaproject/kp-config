...
#repo --name="Fedora %%KP_VERSION%% - %%KP_BASEARCH%% - Development Updates Testing" --baseurl=http://dl.fedoraproject.org/pub/fedora/linux/updates/testing/%%KP_VERSION%%/%%KP_BASEARCH%%/ --cost=1000
